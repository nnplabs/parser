...
export const SupportedProtocolsMapping: Record<string,  (_transaction: types.Transaction, receiverId: string, actions: types.FunctionCallAction[], signerId: string, txHash: string, timestamp: Date) => Promise<TxDetails[]>>= {
    "v2.ref-finance.near": refFinanceTxParser,
